...
class customer_gkv2 extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->from(env('ADMIN_EMAIL'))
            ...
            ->view('emails.customer_gkv2')->with($this->data)->withPercent($this->percent)->withStatus($this->status);
    }
}
