    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div v-if="two == true">
                ...
                <p>Within these pages we will familiarise you with certain areas of the finance industry and help you to understand your role and how important it is to treat customers fairly and ensure finance is sold correctly. Our aim in producing this training course is to break down key areas into easy to understand sections and to support your practices when offering finance to ensure at all times you recognise and meet the FCA Requirements.</p>
                ...
                <p>Not everyone is able or capable of obtaining a consumer credit license and so it is important when undertaking any finance arrangement that you understand the governance of the finance industry, in particular taking the principles, procedures and relevant processes seriously.</p>
                <div class="alert alert-danger" role="alert">Have you read and fully understood this section? Click the "Accept Page" button and then fill out the short question. If you would need extra information please call {{ contactName }} on {{ companyNumber }} or email <a v-bind:href="adminEmail">{{ adminEmail }}</a></div>
            ...
            <div v-if="three == true">
                ...
                <p>Our partnership means that you are able to provide loans and credit agreements through a panel of credit lenders and act under our credit license to sell them. Our firm is described as a credit broker and acts as a “go between” in order to facilitate the loan between the lender and the customer.</p>
            ...
            <div v-if="six == true">
                ...
                <p style="color: red;"><strong>Outcome 4 </strong>- ADVICE<br>Where consumers receive advice, the advice must be suitable and takes account of their circumstances.</p>
            ...
            <div v-if="eight == true">
                ...
                <nav>
                    <ul class="pager">
                        ...
                        <li v-if="answerEight.toLowerCase() == 'yes' " id="buttonNext" style="display: inline;"><a href="#" v-on:click="nextEight">Next</a></li>
                    </ul>
                </nav>
            </div>
            <div v-if="nine == true">
                ...
                <div v-if="acceptNine == true" class="form-group" id="questionNine" style=" margin-top: 95px;">
                    <label >Short question</label>
                    <p>If you have read the above document, please type "yes" into the box below and then click next</p>
                    <input type="text" class="form-control" v-model="answerNine" placeholder="Answer">
                </div>
                <nav>
                    <ul class="pager">
                        <li style="display: inline;"><a v-on:click="previousNine"  href="#">Previous</a></li>
                        <li v-if="answerNine.toLowerCase() == 'yes' " id="buttonNext" style="display: inline;"><a href="#" v-on:click="nextNine">Next</a></li>
                    </ul>
                </nav>
            </div>
            <div v-if="ten == true">
                ...
                <ul style="color: red;">
                    ...
                    <li>State any relationship which is relevant to the services offered. In other words make it clear if you are acting as an associate.</li>
                </ul>
                <p>It is also important that you document this process, otherwise if it isn’t written down it is seen by the FCA as not happening, and so evidence will be required.</p>
                ...
                <div v-if="acceptTen == true" class="form-group" id="questionTen" style=" margin-top: 95px;">
                    <label >Short question</label>
                    <p>If you have read the above document, please type "yes" into the box below and then click next</p>
                    <input type="text" class="form-control" v-model="answerTen" placeholder="Answer">
                </div>
                <nav>
                    <ul class="pager">
                        <li style="display: inline;"><a v-on:click="previousTen"  href="#">Previous</a></li>
                        <li v-if="answerTen.toLowerCase() == 'yes' " id="buttonNext" style="display: inline;"><a href="#" v-on:click="nextTen">Next</a></li>
                    </ul>
                </nav>
            </div>
            <div v-if="eleven == true">
                ...
                <div v-if="acceptEleven == true" class="form-group" id="questionEleven" style=" margin-top: 95px;">
                    <label >Short question</label>
                    <p>If you have read the above document, please type "yes" into the box below and then click next</p>
                    <input type="text" class="form-control" v-model="answerEleven" placeholder="Answer">
                </div>
                <nav>
                    <ul class="pager">
                        <li style="display: inline;"><a v-on:click="previousEleven"  href="#">Previous</a></li>
                        <li v-if="answerEleven.toLowerCase() == 'yes' " id="buttonNext" style="display: inline;"><a href="#" v-on:click="nextEleven">Next</a></li>
                    </ul>
                </nav>
            </div>
            <div v-if="twelve == true">
                ...
                <p>You have a legal obligation to protect your customer’s personal information and we recommend that you register with ICO which stands for the Information Commissioners Office and deals with issues about data protection.</p>
                ...
                <div v-if="acceptTwelve == true" class="form-group" id="questionTwelve" style=" margin-top: 95px;">
                    <label >Short question</label>
                    <p>If you have read the above document, please type "yes" into the box below and then click next</p>
                    <input type="text" class="form-control" v-model="answerTwelve" placeholder="Answer">
                </div>
                <nav>
                    <ul class="pager">
                        <li style="display: inline;"><a v-on:click="previousTwelve"  href="#">Previous</a></li>
                        <li v-if="answerTwelve.toLowerCase() == 'yes' " id="buttonNext" style="display: inline;"><a href="#" v-on:click="nextTwelve">Next</a></li>
                    </ul>
                </nav>
            </div>
            <div v-if="thirteen == true">
                ...
                <div v-if="acceptThirteen == true" class="form-group" id="questionThirteen" style=" margin-top: 95px;">
                    <label >Short question</label>
                    <p>If you have read the above document, please type "yes" into the box below and then click next</p>
                    <input type="text" class="form-control" v-model="answerThirteen" placeholder="Answer">
                </div>
                <nav>
                    <ul class="pager">
                        <li style="display: inline;"><a v-on:click="previousThirteen"  href="#">Previous</a></li>
                        <li v-if="answerThirteen.toLowerCase() == 'yes' " id="buttonNext" style="display: inline;"><a href="#" v-on:click="nextThirteen">Next</a></li>
                    </ul>
                </nav>
            </div>
            <div v-if="fourteen == true">
                ...
                <div v-if="acceptFourteen == true" class="form-group" id="questionFourteen" style=" margin-top: 95px;">
                    <label >Short question</label>
                    <p>If you have read the above document, please type "yes" into the box below and then click next</p>
                    <input type="text" class="form-control" v-model="answerFourteen" placeholder="Answer">
                </div>
                <nav>
                    <ul class="pager">
                        <li style="display: inline;"><a v-on:click="previousFourteen"  href="#">Previous</a></li>
                        <li v-if="answerFourteen.toLowerCase() == 'yes' " id="buttonNext" style="display: inline;"><a href="#" v-on:click="nextFourteen">Next</a></li>
                    </ul>
                </nav>
            </div>
            <div v-if="fifteen == true">
                <h2>Summary</h2>
                <p>Many thanks for taking the time to read this training website, which we hope has helped to educate you on selling finance products and given you a background to the financial industry as a whole.</p>
                <p>With access to this finance facility you could be winning more quotes and expanding your sales.</p>
                <p>Remember we are also on hand to provide you with further help, guidance and advice to meet requirements.</p>
