    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div v-if="two == true">
          ...
          <nav>
            <ul class="pager">
              <li v-if="answerTwo == 'yes' "  style="display: inline;"><a v-on:click="nextTwo" href="#">Next</a></li>
            </ul>
          </nav>
        </div>
        <div v-if="three == true">
          ...
          <nav>
            <ul class="pager">
              ...
              <li v-if="answerThree == 'yes'"  style="display: inline;"><a href="#" v-on:click="nextThree">Next</a></li>
            </ul>
          </nav>
        </div>
        <div v-if="four == true">
          ...
          <nav>
            <ul class="pager">
              ...
              <li v-if="answerFour == 'yes'"  style="display: inline;"><a href="#" v-on:click="nextFour">Next</a></li>
            </ul>
          </nav>
        </div>
        <div v-if="five == true">
          ...
          <h2>Injury in the workplace and Reporting of Injuries, Diseases and Dangerous Occurrences (RIDDOR)</h2>
          <p>
          ...
          <nav>
            <ul class="pager">
              ...
              <li v-if="answerFive == 'yes'"  style="display: inline;"><a  href="#" v-on:click="nextFive">Next</a></li>
            </ul>
          </nav>
        </div>
        <div v-if="six == true">
          <div>
            <h2>Summary</h2>
            <p>Many thanks for taking the time to read this training course, which we hope has helped to educate you.</p>
